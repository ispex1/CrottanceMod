...
public class BlockModelGenerators {
    ...
    protected static MultiVariantGenerator createRotatedVariant(Block p_377300_, ResourceLocation p_377430_) {
        return MultiVariantGenerator.multiVariant(p_377300_, createRotatedVariants(p_377430_));
    }

    protected static Variant[] createRotatedVariants(ResourceLocation p_375451_) {
        return new Variant[]{
    ...
    protected static MultiVariantGenerator createRotatedVariant(Block p_376098_, ResourceLocation p_377321_, ResourceLocation p_378801_) {
    ...
    protected static PropertyDispatch createBooleanModelDispatch(BooleanProperty p_378433_, ResourceLocation p_375735_, ResourceLocation p_376694_) {
    ...
    protected static BlockStateGenerator createButton(Block p_378101_, ResourceLocation p_375992_, ResourceLocation p_377490_) {
    ...
    protected static BlockStateGenerator createFence(Block p_378690_, ResourceLocation p_377844_, ResourceLocation p_376194_) {
    ...
    protected static BlockStateGenerator createWall(Block p_376287_, ResourceLocation p_376637_, ResourceLocation p_376587_, ResourceLocation p_376750_) {
    ...
    protected static BlockStateGenerator createStairs(Block p_377012_, ResourceLocation p_377814_, ResourceLocation p_375598_, ResourceLocation p_378150_) {
    ...
    protected static BlockStateGenerator createOrientableTrapdoor(Block p_378448_, ResourceLocation p_377661_, ResourceLocation p_378435_, ResourceLocation p_378222_) {
    ...
    protected static BlockStateGenerator createTrapdoor(Block p_376522_, ResourceLocation p_376413_, ResourceLocation p_377280_, ResourceLocation p_376962_) {
    ...
    protected static MultiVariantGenerator createSimpleBlock(Block p_377037_, ResourceLocation p_375580_) {
    ...
    protected static BlockStateGenerator createPillarBlockUVLocked(Block p_375885_, TextureMapping p_376939_, BiConsumer<ResourceLocation, ModelInstance> p_378526_) {
    ...
    protected static BlockStateGenerator createAxisAlignedPillarBlock(Block p_375933_, ResourceLocation p_378086_) {
    ...
    protected void createAxisAlignedPillarBlockCustomModel(Block p_375527_, ResourceLocation p_377731_) {
    ...
    protected static BlockStateGenerator createRotatedPillarWithHorizontalVariant(Block p_376711_, ResourceLocation p_376492_, ResourceLocation p_377861_) {
    ...
    protected static BlockStateGenerator createPressurePlate(Block p_378199_, ResourceLocation p_376284_, ResourceLocation p_375449_) {
    ...
    protected static BlockStateGenerator createSlab(Block p_377807_, ResourceLocation p_377877_, ResourceLocation p_378104_, ResourceLocation p_376555_) {
    ...
    protected void createDoubleBlock(Block p_376427_, ResourceLocation p_375937_, ResourceLocation p_377516_) {
        this.blockStateOutput
            .accept(
    ...
    protected ResourceLocation createParticleOnlyBlockModel(Block p_376767_, Block p_377465_) {
    ...
    protected List<Variant> createBambooModels(int p_375570_) {
    ...
    protected Variant createPointedDripstoneVariant(Direction p_377266_, DripstoneThickness p_377993_) {
    ...
    protected List<ResourceLocation> createFloorFireModels(Block p_378241_) {
    ...
    protected List<ResourceLocation> createSideFireModels(Block p_376173_) {
    ...
    protected List<ResourceLocation> createTopFireModels(Block p_375647_) {
    ...
    protected static List<Variant> wrapModels(List<ResourceLocation> p_375990_, UnaryOperator<Variant> p_377102_) {
    ...
    protected void createGrassLikeBlock(Block p_378702_, ResourceLocation p_376191_, Variant p_375414_) {
    ...
    protected void createPistonVariant(Block p_377085_, ResourceLocation p_375394_, TextureMapping p_377851_) {
    ...
    protected ResourceLocation createTurtleEggModel(int p_375779_, String p_376950_, TextureMapping p_378641_) {
        switch (p_375779_) {
            case 1:
    ...
    protected ResourceLocation createTurtleEggModel(Integer p_377508_, Integer p_376221_) {
        switch (p_376221_) {
            case 0:
    ...
    protected void addSlotStateAndRotationVariants(MultiPartGenerator p_375471_, Condition.TerminalCondition p_378599_, VariantProperties.Rotation p_376915_) {
        List.of(
    ...
    protected Variant applyRotation(FrontAndTop p_377309_, Variant p_376792_) {
        switch (p_377309_) {
            case DOWN_NORTH:
