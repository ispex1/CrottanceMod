...
public class ServerChunkCache extends ChunkSource {
    ...
    private void collectTickingChunks(List<LevelChunk> pOutput) {
        ...
        if (!this.chunkMap.hasForcedChunks()) {
            this.chunkMap.forEachSpawnCandidateChunk(this.getChunkCollector(pOutput, chunk -> this.level.isNaturalSpawningAllowed(chunk.getPos())));
            return;
        }
    ...
    private Consumer<ChunkHolder> getChunkCollector(java.util.Collection<LevelChunk> pOutput, java.util.function.Predicate<LevelChunk> predicate) {
        return (p_358696_ -> {
